...
class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String builder = "CREATE TABLE " + Quote.TABLE_NAME + " ("
                ...
                + Quote.COLUMN_HISTORY_1_WEEK + " TEXT NOT NULL, "
                + Quote.COLUMN_HISTORY_1_MONTH + " TEXT NOT NULL, "
                + Quote.COLUMN_HISTORY_6_MONTH + " TEXT NOT NULL, "
                + Quote.COLUMN_HISTORY_1_YEAR + " TEXT NOT NULL, "
                + Quote.COLUMN_HISTORY_2_YEAR + " TEXT NOT NULL, "
